...
export class ScatterLOD {
    constructor (link, scale, count=1, area=10, material=''){
    ...
    generateSimple(){  
        ...
        const mapSprite = new THREE.TextureLoader().load( './assets/textures/food-lemon.png' );
    ...
    async generateDimple(){
        ...
        const mapSprite = new THREE.TextureLoader().load( './assets/textures/pine_sprite_ver3.png' );
        const materialSprite = new THREE.SpriteMaterial( { map: mapSprite } );
